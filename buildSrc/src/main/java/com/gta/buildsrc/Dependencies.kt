...
object Libraries {
    ...
    object PlayService {
        const val AUTH = "com.google.android.gms:play-services-auth:${Versions.PLAY_SERVICES_AUTH}"
        const val LOCATION =
    ...
    const val STREAM_CHAT = "io.getstream:stream-chat-android-ui-components:${Versions.STREAM_CHAT}"
